      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <Typography
              variant="h6"
              sx={{ color: "#f9fafb", mb: 3, fontWeight: 600 }}
            >
                ...
                {pieData[0] && (
                  ...
                  >
                    <Typography variant="body2" sx={{ color: "#f9fafb" }}>
                      بیشترین هزینه شما در دسته{" "}
                      <strong style={{ color: "#8b5cf6" }}>
                        {pieData[0].name}
                      </strong>{" "}
                      با{" "}
                      <strong style={{ color: "#8b5cf6" }}>
                        {pieData[0].value.toLocaleString()} تومان
                      </strong>{" "}
                      بوده است.
                    </Typography>
                  </Box>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            {lineData.length === 0 ||
            lineData.every((d) => d.income === 0 && d.expense === 0) ? (
              <Box
                sx={{
                  height: 300,
                  display: "flex",
